...
class MCPTestRequest(BaseModel):
    ...
    MCPTestRequest
    """ # noqa: E501
    server_name: StrictStr = Field(description="Name of the MCP server to test")
    transport: StrictStr = Field(description="Transport type (stdio, streamable_http, or sse)")
    command: Optional[StrictStr] = None
    args: Optional[List[StrictStr]] = None
    url: Optional[StrictStr] = None
    headers: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["server_name", "transport", "command", "args", "url", "headers"]
