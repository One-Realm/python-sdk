...
class GetUserJiraIntegrationsResponse(BaseModel):
    """
    GetUserJiraIntegrationsResponse
    """ # noqa: E501
    integrations: List[JiraIntegration]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [JiraIntegration.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj
