...
*TeamPermissionsApi* | [**get_team_role_permissions_teams_team_id_role_permissions_get**](docs/TeamPermissionsApi.md#get_team_role_permissions_teams_team_id_role_permissions_get) | **GET** /teams/{team_id}/role-permissions | Get Team Role Permissions
...
*DefaultApi* | [**delete_jira_integration_user_integrations_jira_delete**](docs/DefaultApi.md#delete_jira_integration_user_integrations_jira_delete) | **DELETE** /user/integrations/jira | Delete Jira Integration
...
*DefaultApi* | [**force_refresh_jira_token_endpoint_user_integrations_jira_force_refresh_post**](docs/DefaultApi.md#force_refresh_jira_token_endpoint_user_integrations_jira_force_refresh_post) | **POST** /user/integrations/jira/force-refresh | Force Refresh Jira Token Endpoint
...
*DefaultApi* | [**get_jira_integrations_user_integrations_jira_get**](docs/DefaultApi.md#get_jira_integrations_user_integrations_jira_get) | **GET** /user/integrations/jira | Get Jira Integrations
*DefaultApi* | [**get_jira_login_user_integrations_jira_login_post**](docs/DefaultApi.md#get_jira_login_user_integrations_jira_login_post) | **POST** /user/integrations/jira/login | Get Jira Login
...
*DefaultApi* | [**test_jira_token_endpoint_user_integrations_jira_test_token_get**](docs/DefaultApi.md#test_jira_token_endpoint_user_integrations_jira_test_token_get) | **GET** /user/integrations/jira/test-token | Test Jira Token Endpoint
*DefaultApi* | [**test_mcp_server_mcp_test_post**](docs/DefaultApi.md#test_mcp_server_mcp_test_post) | **POST** /mcp/test | Test an MCP server connection
...
## Documentation For Models
 ...
 - [DeleteJiraIntegrationRequest](docs/DeleteJiraIntegrationRequest.md)
 - [DeleteJiraIntegrationResponse](docs/DeleteJiraIntegrationResponse.md)
 - [DeleteJsonRequest](docs/DeleteJsonRequest.md)
 - [DeleteJsonResponse](docs/DeleteJsonResponse.md)
 - [DeleteOnPremConfluenceConnectorInfoRequest](docs/DeleteOnPremConfluenceConnectorInfoRequest.md)
 - [DeleteOnPremConfluenceConnectorInfoResponse](docs/DeleteOnPremConfluenceConnectorInfoResponse.md)
 ...
 - [GetTeamRolePermissionsResponse](docs/GetTeamRolePermissionsResponse.md)
 ...
 - [GetUserJiraIntegrationsResponse](docs/GetUserJiraIntegrationsResponse.md)
 ...
 - [JiraLoginRequest](docs/JiraLoginRequest.md)
 - [JobId](docs/JobId.md)
 ...
 - [MCPTestRequest](docs/MCPTestRequest.md)
 - [MCPTestResponse](docs/MCPTestResponse.md)
 ...
 - [ResponseAddOnpremConfluencePageToKnowledgeBaseProjectKnowledgeAddOnpremConfluencePost](docs/ResponseAddOnpremConfluencePageToKnowledgeBaseProjectKnowledgeAddOnpremConfluencePost.md)
 ...
 - [SaveOnPremConfluenceConnectorInfoRequest](docs/SaveOnPremConfluenceConnectorInfoRequest.md)
 - [SaveOnPremConfluenceConnectorInfoResponse](docs/SaveOnPremConfluenceConnectorInfoResponse.md)
